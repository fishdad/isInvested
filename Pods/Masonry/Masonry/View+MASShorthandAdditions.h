...
@property (nonatomic, strong, readonly) MASViewAttribute *kMarginLeft;
@property (nonatomic, strong, readonly) MASViewAttribute *rightMargin;
@property (nonatomic, strong, readonly) MASViewAttribute *kMarginTop;
...
MAS_ATTR_FORWARD(kMarginLeft);
MAS_ATTR_FORWARD(rightMargin);
MAS_ATTR_FORWARD(kMarginTop);
